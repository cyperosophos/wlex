...
# TODO: move to cells.py
# This is required when comparing instances of Sequence types.
def _full_eq(x: Sequence, y: Sequence):
    ...
    return (
        ...
        and length == len(y)
        and all(x[i] == y[i] for i in range(length))
    )
